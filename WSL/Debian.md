...
```bash
sudo apt install vim curl man bash-completion openssh-server socat dnsutils traceroute rsync zip unzip diffutils git tmux plocate htop fastfetch distrobox wl-clipboard
